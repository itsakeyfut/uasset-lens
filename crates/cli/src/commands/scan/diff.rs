...
use super::format_time::format_utc;
...
pub(super) struct DiffInput<'a> {
    pub assets: &'a [scanner::AssetMetadata],
    pub old_bp: HashMap<shared::AssetPath, (u32, u32)>,
    pub old_sizes: HashMap<shared::AssetPath, u64>,
...
pub(super) fn print_diff(
    ...
    let deleted_asset_paths: Vec<String> = input
        .stale
        .iter()
        .filter_map(|p| shared::AssetPath::from_fs_path(input.content_root, p).ok())
