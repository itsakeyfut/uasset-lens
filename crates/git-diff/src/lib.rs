...
pub fn diff_asset(
    ...
    let old_result = scanner::scan_files(&[temp_file], temp_dir.path());
    let new_result = scanner::scan_files(&[file_path], content_root);
...
pub(crate) fn compute_diff(
    asset_path: AssetPath,
    old: scanner::AssetMetadata,
    new: scanner::AssetMetadata,
) -> AssetDiff {
...
mod tests {
    ...
    fn make_meta(
        ...
        blueprint_metrics: Option<scanner::BlueprintMetrics>,
