...
mod tests {
    ...
    fn check_budget_should_return_no_violations_when_all_assets_are_within_budget() {
        ...
        let assets = vec![uasset_lens_asset_db::AssetRecord {
            file_size: 4096,
            ..uasset_lens_asset_db::make_record("/Game/T_Rock", AssetType::Texture2D)
        }];
    ...
    fn check_budget_should_report_violation_when_asset_is_one_byte_over_budget() {
        ...
        let assets = vec![uasset_lens_asset_db::AssetRecord {
            file_size: 4097,
            ..uasset_lens_asset_db::make_record("/Game/T_Large", AssetType::Texture2D)
        }];
    ...
    fn check_budget_should_not_report_violation_when_asset_type_has_no_budget() {
        ...
        let assets = vec![uasset_lens_asset_db::AssetRecord {
            file_size: 1_000_000,
            ..uasset_lens_asset_db::make_record("/Game/SM_Rock", AssetType::StaticMesh)
        }];
    ...
    fn check_budget_should_report_violations_per_type_with_independent_budgets() {
        ...
        let assets = vec![
            uasset_lens_asset_db::AssetRecord {
                file_size: 4096,
                ..uasset_lens_asset_db::make_record("/Game/T_OK", AssetType::Texture2D)
            },
            uasset_lens_asset_db::AssetRecord {
                file_size: 5000,
                ..uasset_lens_asset_db::make_record("/Game/T_Big", AssetType::Texture2D)
            },
            uasset_lens_asset_db::AssetRecord {
                file_size: 2048,
                ..uasset_lens_asset_db::make_record("/Game/SW_OK", AssetType::SoundWave)
            },
            uasset_lens_asset_db::AssetRecord {
                file_size: 3000,
                ..uasset_lens_asset_db::make_record("/Game/SW_Big", AssetType::SoundWave)
            },
        ];
