...
mod tests {
    ...
    fn build_json_node_should_produce_correct_path_type_size_and_nested_deps() {
        let graph = uasset_lens_dependency_graph::DependencyGraph::build(
            vec![
                uasset_lens_dependency_graph::AssetNode {
                    path: uasset_lens_shared::AssetPath::new("/Game/Root").unwrap(),
                    asset_type: uasset_lens_shared::AssetType::Blueprint,
                },
                uasset_lens_dependency_graph::AssetNode {
                    path: uasset_lens_shared::AssetPath::new("/Game/Dep").unwrap(),
                    asset_type: uasset_lens_shared::AssetType::Texture2D,
                },
            ],
            vec![(
                uasset_lens_shared::AssetPath::new("/Game/Root").unwrap(),
                uasset_lens_shared::AssetPath::new("/Game/Dep").unwrap(),
            )],
            &[] as &[&str],
        );
        ...
        asset_map.insert(
            uasset_lens_shared::AssetPath::new("/Game/Root").unwrap(),
            (uasset_lens_shared::AssetType::Blueprint, 2048),
        );
        asset_map.insert(
            uasset_lens_shared::AssetPath::new("/Game/Dep").unwrap(),
            (uasset_lens_shared::AssetType::Texture2D, 512),
        );
        let mut in_path = HashSet::new();
